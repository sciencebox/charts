...
*/}}
{{- define "eos-user-cache-refresher.name" -}}
...
*/}}
{{- define "eos-user-cache-refresher.fullname" -}}
...
*/}}
{{- define "eos-user-cache-refresher.chart" -}}
...
Common labels
*/}}
{{- define "eos-user-cache-refresher.labels" -}}
helm.sh/chart: {{ include "eos-user-cache-refresher.chart" . }}
{{ include "eos-user-cache-refresher.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels
*/}}
{{- define "eos-user-cache-refresher.selectorLabels" -}}
app.kubernetes.io/name: {{ include "eos-user-cache-refresher.name" . }}
...
*/}}
{{- define "eos-user-cache-refresher.serviceAccountName" -}}
{{- if .Values.serviceAccount.create -}}
    {{ default (include "eos-user-cache-refresher.fullname" .) .Values.serviceAccount.name }}
{{- else -}}
